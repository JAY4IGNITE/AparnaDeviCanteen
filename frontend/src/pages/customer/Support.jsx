...
const SUPPORT_CONTACTS = [
  {
    ...
    badge: 'Canteen Incharge',
    name: 'Canteen Incharge',
    phone: '9603649488',
    ...
    whatsappMsg: 'Hi Canteen Incharge, I need assistance with my order.',
  },
  {
    id: 'kitchen',
    role: 'Supporting Team',
    badge: 'Supporting Team',
    ...
    icon: ChefHat,
    options: ['call', 'whatsapp'],
    whatsappMsg: 'Hi Supporting Team, I am inquiring about my order preparation.',
  },
  {
    id: 'admin',
    ...
    icon: ShieldCheck,
    options: ['whatsapp'],
    whatsappMsg: 'Hi Admin & Technical Support, I need help regarding a payment / portal issue on the canteen website.',
  },
];
